...
# Set paths
data_dir = "/Users/akashadhyapak/Documents/ML/Brain Stroke detection/basedir"  # Update this path
...
# SVM Model with Regularization (C=0.1 for stronger regularization)
svm_model = SVC(kernel='linear', C=0.1, random_state=157)
