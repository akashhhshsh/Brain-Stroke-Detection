...
# Set paths
data_dir = "/Users/akashadhyapak/Documents/ML/Brain Stroke detection/basedir"  # Update this path to your dataset
...
train_generator = datagen.flow_from_directory(
    ...
    class_mode='binary',  # Binary classification for normal vs affected brain
    subset='training',
    shuffle=False
)
...
disp = ConfusionMatrixDisplay(confusion_matrix=cm, display_labels=['Normal', 'Affected'])
disp.plot(cmap='Blues')
plt.title('Confusion Matrix for SVM Classifier (Brain Images)')
plt.show()
